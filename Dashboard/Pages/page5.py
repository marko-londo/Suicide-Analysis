...
russia_suicides = pd.read_csv(
    r"../Resources/Clean/russia_suicides_1985-2016.csv"
)
paraguay_suicides = pd.read_csv(
    r"../Resources\Clean\paraguay_suicides_1985-2016.csv"
)
japan_suicides = pd.read_csv(
...
def show():
    ...
    us_plot = us_suicides_filtered.hvplot(
    ...
    with col1:
        st.write(hv.render(us_plot, backend="bokeh"))
    with col2:
